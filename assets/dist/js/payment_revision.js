...
function initPaymentRevisionDT(){    
    dt_payment_revision = $('#dt-payment-revision').DataTable({
        ajax : '../l-fis/payment/getSelectedPayment?student_id='+$('#student_id').html()+'&payment_type_id='+$('#payment_type_id').html(),
        dom: 'Bfrtip', //B -> Button
        buttons: [
            {
...
function getUpdatePaymentRevision(i){
    ...
    ajaxPro('POST', '/l-fis/payment/getById', formData, 'json', false, false, false, false, success, success, null);          
