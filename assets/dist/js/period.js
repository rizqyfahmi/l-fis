...
function insert(formData){
    ...
    ajaxPro('POST', '/l-fis/period/insert', formData, 'html', false, false, false, false, success, success, null);          
...
function edit(formData){        
    ajaxPro('POST', '/l-fis/period/edit', formData, 'html', false, false, false, false, success, success, null);          
    function success(output) {            
        dt_period.ajax.reload();
        $("#form-period")[0].reset();
        $("#form-period").bootstrapValidator('resetForm', true); 
...
function getEditPeriod(i){
    ...
    var formData = new FormData($(this)[0]);        
    formData.append('period_id', period_id);                        
    ajaxPro('POST', '/l-fis/period/getById', formData, 'json', false, false, false, false, success, success, null);          
    function success(output) {   
...
function getDeletePeriod(i){
    ...
    var formData = new FormData($(this)[0]);        
    formData.append('period_id', period_id);                        
    ajaxPro('POST', '/l-fis/period/delete', formData, 'html', false, false, false, false, success, success, null);          
    function success(output) {   
        dt_period.ajax.reload();
        notify('info', output, null);
    } 
