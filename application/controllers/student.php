    ...
    public function getPayment() {
        ...
        try {      
            if($q1 = $this->model_student->getById2($id)){
                ...
                if($q2 = $this->model_student->getPayment($id, $education_id, $period_id)){
                    $first_sub = array();
                    foreach ($q2 as $r) {                    
                        array_push($first_sub, $r);
                    }
    ...
    public function getSelectedPrimaryPayment() {
        ...
        try {                
            if($q1 = $this->model_student->getById2($id)){
                $education_id = $q1->education_id;
                $period_id = $q1->period_id;
                if ($q2 = $this->model_student->getSelectedPrimaryPayment($id, $education_id, $period_id)) {                                
                    $data = array('data' => $q2);               
                }    
            }                                
        } catch (Exception $e) {
    ...
    public function getSelectedPrimaryPayment2() {
        ...
        try {                
            if($q1 = $this->model_student->getById2($id)){
                $education_id = $q1->education_id;
                $period_id = $q1->period_id;
                if ($q2 = $this->model_student->getSelectedPrimaryPayment2($id, $education_id, $period_id)) {                                
                    $data = array('data' => $q2);               
                }    
            }                                
        } catch (Exception $e) {
