...
function inputTypeSetting(){    
    $('#form-staff').bootstrapValidator({
        ...
        $('#form-staff').submit(function (event) {
            ...
            if (id_length>0) {
                ajaxPro('POST', '/l-fis/staff/edit', formData, 'html', false, false, false, false, success, success, null);       
            }else{
                var d = new Date();     
                ...
                ajaxPro('POST', '/l-fis/staff/insert', formData, 'html', false, false, false, false, success, success, null);          
            }            
            function success(output) {            
...
function settingProfilUpdate(){    
    $('#form-setting-profil').bootstrapValidator({
        ...
        $('#form-setting-profil').submit(function (event) {
            ...
            var formData = new FormData($(this)[0]);                
            ajaxPro('POST', '/l-fis/staff/settingProfil', formData, 'html', false, false, false, false, success, success, null);       
            function success(output) {            
        ...
        fields: {
            old_password: {
                ...
                validators: {
                    ...
                    remote: {
                        type: 'POST',
                        url: '/l-fis/staff/getCurrentPassword',
...
function settingPhotoUpdate(){    
    $('#form-setting-photo').submit(function (event) {
        ...
        var id_length = $('#form-setting-profil input[name=staff_id]').val().split('').length;
        var formData = new FormData($(this)[0]);                
        ajaxPro('POST', '/l-fis/staff/settingPhoto', formData, 'html', false, false, false, false, success, success, null);       
        function success(output) {                                              
            notify('info', output, null);                                
        }   
        return false;
...
function settingDatabase(){    
    $('#form-setting-database').submit(function (event) {
        event.preventDefault();                        
        var formData = new FormData($(this)[0]);                
        ajaxPro('POST', '/l-fis/setting/exportDB', formData, 'html', false, false, false, false, success, success, null);       
        function success(output) {                                              
            notify('info', output, null);                                
        }   
        return false;
...
function settingUsernameUpdate(){    
    $('#form-setting-username').bootstrapValidator({
        ...
        fields: {
            username: {
                ...
                validators: {
                    ...
                    remote: {
                        type: 'POST',
                        url: '/l-fis/staff/getAvailableUsername',
        ...
        $('#form-setting-username').submit(function (event) {
            event.preventDefault();                            
            var formData = new FormData($(this)[0]);                
            ajaxPro('POST', '/l-fis/staff/settingUsername', formData, 'html', false, false, false, false, success, success, null);       
            function success(output) {            
...
function getEditSetting(i){
    ...
    var formData = new FormData($(this)[0]);        
    formData.append('staff_id', staff_id);                        
    ajaxPro('POST', '/l-fis/staff/getById', formData, 'json', false, false, false, false, success, success, null);          
    function success(output) {   
...
function getDeleteSetting(i){
    ...
    var formData = new FormData($(this)[0]);        
    formData.append('staff_id', staff_id);                        
    ajaxPro('POST', '/l-fis/staff/delete', formData, 'html', false, false, false, false, success, success, null);          
    function success(output) {   
        dt_setting_user.ajax.reload();
        notify('info', output, null);
    } 
