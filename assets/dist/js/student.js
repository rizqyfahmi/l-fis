...
function saveEditStudent(){    
    $('#form-student').bootstrapValidator({
        ...
        $('#form-student').submit(function (event) {
            ...
            ajaxPro('POST', '/l-fis/student/edit', formData, 'html', false, false, false, false, success, success, null);       
...
function getProfileStudent(i){
    ...
    ajaxPro('POST', '/l-fis/student/getById', formData, 'json', false, false, false, false, success, success, null);          
    function success(output) {           
