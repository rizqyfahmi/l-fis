...
function inputTypeEducation(){    
    $('#form-education').bootstrapValidator({
        ...
        $('#form-education').submit(function (event) {
            ...
            if (id_length>0) {
                ajaxPro('POST', '/l-fis/education/edit', formData, 'html', false, false, false, false, success, success, null);          
            }else{
                var d = new Date();         
                ...
                ajaxPro('POST', '/l-fis/education/insert', formData, 'html', false, false, false, false, success, success, null);          
            }
...
function getEditEducation(i){
    ...
    var formData = new FormData($(this)[0]);        
    formData.append('education_id', education_id);                        
    ajaxPro('POST', '/l-fis/education/getById', formData, 'json', false, false, false, false, success, success, null);          
    function success(output) {   
...
function getDeleteEducation(i){
    ...
    var formData = new FormData($(this)[0]);        
    formData.append('education_id', education_id);                        
    ajaxPro('POST', '/l-fis/education/delete', formData, 'html', false, false, false, false, success, success, null);          
    function success(output) {   
        dt_education.ajax.reload();
        notify('info', output, null);
    } 
