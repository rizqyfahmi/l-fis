...
function inputTypePaymentType(){    
    $('#form-payment-type').bootstrapValidator({
        ...
        $('#form-payment-type').submit(function (event) {
            ...
            if (id_length>0) {                
                ajaxPro('POST', '/l-fis/payment_type/edit', formData, 'html', false, false, false, false, success, success, null);                          
            }else{                
                var d = new Date();         
                ...
                ajaxPro('POST', '/l-fis/payment_type/insert', formData, 'html', false, false, false, false, success, success, null);                          
            }
...
function initPaymentTypeDT(){
    dt_payment_type = $('#dt-payment-type').DataTable({
        ajax : '../l-fis/payment_type/getAll',
        //        dom: 'lfrtip', //B -> Button
        //        //        buttons: [
...
function getEditPaymentType(i){
    ...
    ajaxPro('POST', '/l-fis/payment_type/getById', formData, 'json', false, false, false, false, success, success, null);          
    function success(output) {                   
...
function getDeletePaymentType(i){
    ...
    var formData = new FormData($(this)[0]);        
    formData.append('payment_type_id', payment_type_id);                      
    ajaxPro('POST', '/l-fis/payment_type/delete', formData, 'html', false, false, false, false, success, success, null);          
    function success(output) {   
        dt_payment_type.ajax.reload();
        notify('info', output, null);
    } 
